 ...
 sliderpic = {}
 sliderpic.pic = love.graphics.newImage('slider bar.png')
 sliderpic.arrowpic = love.graphics.newImage('upside down triangle.png')
 function slider.make(att) --att stands for attributes
	...
	s.arrowheight = att.arrowheight or 30
	s.arrowwidth = att.arrowwidth or 15
...
function slider:draw()
	...
	love.graphics.print(math.round(self.value * self.multiplyer,self.round),self.x +self.width - self.multiplyerwidth, self.y + self.height )
 end
