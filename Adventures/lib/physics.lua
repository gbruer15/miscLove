...
function createImmovableObject(traitlist) --grav is pixels per second per second,  rotation speed is in radians per second
	...
	xposition = traitlist.xposition or 0, 
	yposition = traitlist.yposition or 0,
...
function updatePhysics(dt)
	for i,thing in pairs(objects) do
		thing.xposition = thing.xposition + thing.xspeed*dt * metersize
		thing.yposition = thing.yposition + thing.yspeed*dt * metersize
