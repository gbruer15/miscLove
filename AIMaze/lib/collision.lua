...
function collision.lineRectangle(vx,vy,vx2,vy2,left,top,width,height) -- only works if at least one point is outside rectangle
	return collision.lines(vx,vy,vx2,vy2,left,top,left+width,top) or collision.lines(vx,vy,vx2,vy2,left,top,left,top+height) or collision.lines(vx,vy,vx2,vy2,left+width,top,left+width,top+height) or collision.lines(vx,vy,vx2,vy2,left+width,top+height,left,top+height)
end

function collision.lines(ax,ay,bx,by, ox,oy,px,py)
